...
<section class="hero-section text-white">
    <div class="container text-center">
        <h1 class="display-5 mb-3">Add New Driver</h1>
        <p class="lead">Expand our team of professional drivers</p>
    </div>
</section>
...
<div class="container">
    <div class="form-card p-4 p-md-5">
        ...
        <form method="post" action="adddriver">
            <div class="mb-4">
                <label class="form-label"><i class="fas fa-id-badge me-2"></i>Driver ID</label>
                <input type="text" class="form-control form-control-lg" 
                       name="driver_id" placeholder="Enter driver ID" required>
            </div>

            <div class="mb-4">
                <label class="form-label"><i class="fas fa-user me-2"></i>Full Name</label>
                <input type="text" class="form-control form-control-lg" 
                       name="name" placeholder="Enter driver's full name" required>
            </div>

            <div class="mb-4">
                <label class="form-label"><i class="fas fa-id-card me-2"></i>License Number</label>
                <input type="text" class="form-control form-control-lg" 
                       name="license_number" placeholder="Enter license number" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="tel" class="form-control form-control-lg" 
                       name="contact_no" placeholder="Enter contact number" required>
            </div>
