...
<head>
    ...
    <title>Update Customer - Mega City Cab Service</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="regstb"><i class="fas fa-users me-2"></i>Customers</a></li>
...
<section class="hero-section text-white">
    <div class="container text-center">
        <h1 class="display-5 mb-3">Update Customer Profile</h1>
        <p class="lead">Maintain accurate customer information for better service</p>
    </div>
</section>
    ...
    <div class="form-card p-4 p-md-5">
        ...
        <form method="post" action="regup">
            <div class="row g-3 mb-4">
                <div class="col-md-6">
                    <label class="form-label"><i class="fas fa-id-card me-2"></i>Registration No</label>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="reg.jsp" class="text-white text-decoration-none">New Registration</a></li>
                    <li><a href="regstb" class="text-white text-decoration-none">Customer List</a></li>
                </ul>
            </div>
            <div class="col-md-4">
                <h4>Follow Us</h4>
