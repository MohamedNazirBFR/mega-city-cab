...
<head>
    ...
    <title>Customers - Mega City Cab Service</title>
    <!-- Bootstrap 5 CSS -->
...
<section class="hero-section text-white">
    <div class="container text-center">
        <h1 class="display-5 mb-3">Registered Customers</h1>
        <p class="lead">Manage customer records efficiently</p>
    </div>
</section>
...
<div class="container">
    <c:if test="${empty cust}">
        <div class="alert alert-warning text-center">
            <h5 class="mb-0"><i class="fas fa-exclamation-triangle me-2"></i>No customers found in the database</h5>
        </div>
    </c:if>
            ...
            <table class="table table-hover align-middle">
                <thead>
                    <tr>
                        ...
                        <th><i class="fas fa-address-card me-2"></i>NIC</th>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><i class="fas fa-envelope me-2"></i>customers@megacity.lk</li>
                </ul>
            </div>
            <div class="col-md-4">
                <h4>Quick Links</h4>
